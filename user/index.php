...
<body>
    ...
    <main>
        <img src="/bakery_management/images/istockphoto-501999096-612x612.jpg" alt="" class="image2">
        </main>
    <div class="container1" id="one">
        <h3><a name="recommend">Recommended</a></h3>
    </div>
...
<div class="container3">
    ...
    <div class="about1">
        <h4>More Pages</h4>
        <ul>
            <li><a href="#recommend">Recommanded</a></li>
