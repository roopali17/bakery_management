...
<body>
    <div class="container">
        <div class="row">
            <h1>Add Bakery Products</h1>
        </div>
        <form action="add-delete-bakery-products.php" method="POST" enctype="multipart/form-data"  name="myForm" onsubmit="return validateForm()">
            <div class="card-body">
                <div class="row2">
                ...
                <div class="row5">
                    <button type="submit" name = "add_bakery-products" class="btn">Add</button>
                </div>
                </div>
    </form>
</body>
