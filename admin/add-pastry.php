...
<body>
    <div class="container">
        ...
        <form action="add-delete-pastry.php" method="POST" enctype="multipart/form-data"  name="myForm" onsubmit="return validateForm()">
            <div class="card-body">
                <div class="row2">
                ...
                <div class="row5">
                    <button type="submit" name = "add_pastry" class="btn">Add</button>
                </div>
                </div>
    </form>
</body>
