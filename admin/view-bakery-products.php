...
<body>
    ...
    <?php
        ...
        <div class="add">
        <a href="add-bakery-products.php">Add item</a>
        </div>
        <div class="tab">
            <table>
                <thead>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <form action="add-delete-bakery-products.php" method="POST">
                                    <button type="submit" name="bakery-products_delete" value="<?=$row['id'];?>" class="btn">Delete
                                    </button>
                                    </form>
                                </td> 
                            </tr>
